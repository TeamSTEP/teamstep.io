...
> {
    ...
    touchMove = e => {
        if (this.state.touchDown) {
            if (this.state.opening) {
                ...
                let progress =
                    (e.touches[0].pageX / (this.state.screenWidth * 0.7)) * 100;
    ...
    openSidebar = () => {
        ...
        this.sidebarParent.current.style.transitionDuration = `${remaining /
            500}s`;
        this.sidebarOverlay.current.style.transitionDuration = `${remaining /
            500}s`;
