...
image: ./image.png
banner: ./image.png
description: We are looking for a pixel artist who would like to be part of the team for Witch One
---
...
We are looking for team members to work with on this simple project called Witch One **(working title)**.
...
Witch One is a simple 30 player 2D top-down perspective battle-royal game set in a medieval fantasy world with sorceresses and witches from different cultures that gather together.
...
You can see the current team members involved from <a href="https://github.com/TeamSTEP/Witch OneProjectBoard/blob/master/TeamMemberList.csv">this</a> page (updated regularly).
...
Witch One is developed using Unity `2019.4.8f1` and it will stay that will until the game is finished (assuming there's no breaking bug in the engine itself).
...
-   Witch One GDD: <https://team-step.gitbook.io/catch-io-design-doc/>
-   Witch One code documentation: <https://team-step.gitbook.io/catch-io-dev-doc/>
-   Current team members: <https://github.com/TeamSTEP/Witch OneProjectBoard/blob/master/TeamMemberList.csv>
