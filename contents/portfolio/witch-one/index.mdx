---
title: Witch One
description: Witch One is a online stealth-focused battle-royal inspired strategy game where you try to catch people from the back without getting noticed
date: 2020-10-12
image: ./title-cover.jpg
banner: ./title-cover.jpg
---

## About the Project

Witch One is a cross-platform battle-royal catch game that focuses on stealth and traps rather than fast-paced action.
...
Development started from March of 2020 and it is still under sactive development.
...
![image](./map-editor.jpg)

</Col>
</Row>

The internal project alias is called Catch.io, so many of the development documents may reference this project with a different name.
